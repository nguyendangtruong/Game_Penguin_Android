    ...
    public float Horizontal => m_Character.SwipeControlsLeftRight;//Input.GetAxisRaw("Horizontal"); //m_Character.SwipeControlsLeftRight;
        public float Vertical => m_Character.MoveForwardBehind; //Input.GetAxisRaw("Vertical");
        public bool Jump => (m_Character.SwipeUp || Input.GetButtonDown("Jump")); // Input.GetButtonDown("Jump");
